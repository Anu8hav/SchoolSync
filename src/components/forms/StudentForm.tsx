...
const schema = z.object({
  ...
  // 🔹 Treat birthday as the string coming from <input type="date" />
  birthday: z.string().min(1, { message: "Birthday is required!" }),

  sex: z.enum(["male", "female"], { message: "Sex is required!" }),

  // 🔹 File validation using custom instead of instanceof(File)
...
const StudentsForm = ({
  ...
  return (
    <form className="flex flex-col gap-8 max-w-4xl w-full" onSubmit={onSubmit}>
